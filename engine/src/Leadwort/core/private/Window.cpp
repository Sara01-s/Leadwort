...
namespace Leadwort::Core {
	...
	void Window::SetIcons() const {
		const std::array<std::string, 4>& iconPaths = {
			AssetManagement::EngineAssets::ResolvePath("textures/icons/tex_icon_16.png"),
			AssetManagement::EngineAssets::ResolvePath("textures/icons/tex_icon_32.png"),
			AssetManagement::EngineAssets::ResolvePath("textures/icons/tex_icon_48.png"),
			AssetManagement::EngineAssets::ResolvePath("textures/icons/tex_icon_256.png"),
		};
